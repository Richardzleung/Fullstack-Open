...
router.post('/:id/comments', async (request, response) => {
  ...
  const comments = { comments:initialBlog.comments.concat(request.body.comments) }
...
router.delete('/:id', async (request, response) => {
  ...
  console.log('user', decodedToken, 'blog', blog)
...
router.post('/', async (request, response) => {
  ...
  blog.user = { username: user.username, id: user._id }
